...
const Hero = () => {
    return (
        <div className="container flex h-[500px] w-11/12 flex-col items-center justify-center xl:h-[600px] xl:w-8/12">
            <div className="mb-2 flex flex-col items-center text-center text-primary">
            ...
            <p className="mb-4 text-center text-lg text-gray-200">Somos desarrolladores expertos para potenciar la presencia online.</p>
