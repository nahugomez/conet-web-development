...
const Pattern = ({ className }) => {
    return (
        <svg id="patternId" className={className} width="100%" height="150px" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="a" patternUnits="userSpaceOnUse" width="40" height="69.282" patternTransform="scale(2) rotate(0)">
